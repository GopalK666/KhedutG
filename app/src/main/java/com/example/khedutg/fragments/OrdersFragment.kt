...
import com.example.khedutg.adapters.AdapterOrders
import com.example.khedutg.databinding.FragmentOrdersBinding
                ...
                if (orderList.isNotEmpty()){
                    ...
                    for (orders in orderList){
                        ...
                        for (products in orders.orderList!!){
                            val price = products.productPrice?.substring(1)?.toDoubleOrNull()?.toInt() ?: 0
