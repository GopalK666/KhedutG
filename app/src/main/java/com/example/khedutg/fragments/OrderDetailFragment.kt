...
import com.example.khedutg.databinding.FragmentOrderDetailBinding
...
class OrderDetailFragment : Fragment() {
    ...
    private fun settingStatus() {
        ...
        for (view in viewsToTint){
            view.backgroundTintList = ContextCompat.getColorStateList(requireContext(), R.color.fullgreen)
        }
    }
