package com.example.khedutg.adapter
...
import com.example.khedutg.FilteringProducts
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            for (i in 0 until productImage?.size!!) {
                imageList.add(SlideModel(product.productImage!![i].toString()))
            }
            imageSlider.setImageList(imageList)


            tvProductTitle.text = product.productTitle
            tvProductQuantity.text = product.productUnit
            tvProductPrice.text = "₹${product.price ?: 0.0}"
